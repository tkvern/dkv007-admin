...
class AdminsController extends Controller
{
    ...
    public function form()
    {
        return Administrator::form(function (Form $form) {
            ...
            $form->password('password', trans('admin::lang.password'))->value('')->rules('min:6|confirmed');
            $form->password('password_confirmation', trans('admin::lang.password_confirmation'))->value('');
