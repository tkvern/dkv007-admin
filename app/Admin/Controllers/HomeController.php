    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->row(function ($row) {
                ...
                $order_count = TaskOrder::count();
                $task_count = Task::count();
                $row->column(3, new InfoBox('用户', 'users', 'aqua', '/admin/users', $user_count));
                $row->column(3, new InfoBox('订单', 'shopping-cart', 'aqua', '/admin/task_orders', $order_count));
                $row->column(3, new InfoBox('作业', 'tasks', 'aqua', '/admin/tasks', $task_count));
